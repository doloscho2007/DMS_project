...
const MainbarHeader = () => {
  ...
  const FileSplitMeth = () => {
    if (NullCheck === 0) {
      ...
      console.log("Multi File Split Not Allowed");
      setSnackbarMessage("Multi File Split Not Allowed");
      setSnackbarSeverity("warning");
      setOpen(true);
    } else {
  ...
  const FileMergeMeth = () => {
    if (NullCheck === 0) {
      ...
      console.log("Multi File Merge Not Allowed");
      setSnackbarMessage("Multi File Merge Not Allowed");
      setSnackbarSeverity("warning");
      setOpen(true);
    } else {
  ...
  const FileStampMeth = () => {
    if (NullCheck === 0) {
      ...
      console.log("Multi File Stamp Not Allowed");
      setSnackbarMessage("Multi File Stamp Not Allowed");
      setSnackbarSeverity("warning");
      setOpen(true);
    } else {
      ...
      <div display="flex" style={{ padding: "0", margin: "0" }}>
        ...
        <Tooltip title="Download File">
          ...
          >
            <FileDownloadOutlinedIcon
              color={checkOutOpen ? "neutral" : "secondary"}
            />
          </IconButton>
        </Tooltip>
        ...
        <Tooltip title="Merge PDF">
          ...
          >
            {theme.palette.mode === "dark" ? (
              ...
              <DifferenceIcon color={checkOutOpen ? "neutral" : "secondary"} />
            )}
          </IconButton>
        </Tooltip>
        <BootstrapDialog
        ...
        <Tooltip title="Delete">
          ...
          <IconButton
            ...
            disabled={checkOutOpen || bookmarkOpen ? true : false}
          >
            {theme.palette.mode === "dark" ? (
              <DeleteOutlineOutlinedIcon
                color={checkOutOpen || bookmarkOpen ? "neutral" : "secondary"}
              />
            ) : (
              <DeleteIcon color={checkOutOpen ? "neutral" : "secondary"} />
            )}
          </IconButton>
        </Tooltip>
        <BootstrapDialog
        ...
        <Tooltip title="Print">
          ...
          >
            {theme.palette.mode === "dark" ? (
              ...
              <PrintIcon color={checkOutOpen ? "neutral" : "secondary"} />
            )}
          </IconButton>
        </Tooltip>
        ...
        <Tooltip title="Stamp">
          ...
          >
            {theme.palette.mode === "dark" ? (
              ...
              <ApprovalIcon color={checkOutOpen ? "neutral" : "secondary"} />
            )}
          </IconButton>
        </Tooltip>
        <BootstrapDialog
