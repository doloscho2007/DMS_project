  ...
  return (
     <Box display="flex" justifyContent="start" sx={{padding:'0',margin:'0'}}>
      ...
      >
        ...
        noValidate autoComplete="off" >
                <span>File Name : </span>
                <input  type="file" id="myFile" name="filename" multiple onChange={handleFileChange}/><br></br>
                 <div>
                ...
                <div id="selectedFiles">
                  {
                    selectedFiles.map((file) => {
                      return(
                          <><p style={{display:"flex" }}>{file.name}<DeleteIcon onClick={() => handleRemoveItem(file.name)} /></p></>
                      )})}
                </div> 
