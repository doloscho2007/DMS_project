...
const getCheckoutStatus = async (fileId) => {
  const user = JSON.parse(localStorage.getItem("user"));
  const url = api_url + "getCheckoutStatus?fileId=" + fileId;
...
const getBookmarkStatus = async (fileId) => {
  const user = JSON.parse(localStorage.getItem("user"));
  const url = api_url + "getBookmarkStatus?fileId=" + fileId;
...
const downloadFileOld = async (fileId, filePath, pdfFile) => {
  const user = JSON.parse(localStorage.getItem("user"));
  const url =
    api_url +
    "downloadFileOld?fileId=" +
    fileId +
    "&filePath=" +
    filePath +
    "&pdfFile=" +
