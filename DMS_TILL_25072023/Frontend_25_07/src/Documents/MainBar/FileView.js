...
export default function FileView() {
  ...
  const [showLoader1CheckinFolder, setShowLoader1CheckinFolder] = useState(false);
  ...
  const handleCheckin = async (e) => {
    ...
    if (selectedFiles.length === 0) {
      ...
      try {
        ...
        // console.log(data.message);
        if (response.status === 200) {
          setSnackbarMessage("File Checkin completed Successfully");
          setSnackbarSeverity("success");
          setOpen(true);
          setShowLoaderCheckinFolder(false);
        ...
        <div>
          <ContextMenu top={points.y} left={points.x}>
            <ul>
              ...
              <li
                className={
                  (bookMarkStatus === "Bookmark Not Present" ? "" : "disabled",
      ...
      >
        ...
        <DialogContent dividers>
          ...
          >
            ...
            <div>
                {showLoaderCheckinFolder === true && showLoader1CheckinFolder === false ? <div ><h1>Loading...</h1></div> : 
                <>{showLoaderCheckinFolder === false && showLoader1CheckinFolder === false ? <h1></h1> : <h1> File Added</h1>}</>}
            </div> 
          </Box>
        </DialogContent>
        <DialogActions>
