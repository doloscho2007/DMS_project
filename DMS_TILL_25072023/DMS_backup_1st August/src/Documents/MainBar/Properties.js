...
const Properties = () => {
  const { editForm,propUp,handleRefresh, handlefileUpdate } = useGlobalContext();
  ...
  return (
    <div style={{ width: "100%", height: "10rem",alignItems: "center" }}>
        ...
        <div
          style={{ display: "flex", width: "100%", alignItems: "center", marginBottom: "5px" }}
        >
          ...
          />
          <span style={{ flex: "1", height: "20px",paddingLeft:propUp?"100px":"2px"}}>File Date :</span>
          <input
            type="date"
            id="createdDate2"
            style={{ flex: "1", height: "20px",marginLeft:propUp?"50px":"20px" }}
            name="File Date"
            value={fileDate}
        ...
        >
          ...
          />
          <span style={{ flex: "1", height: "20px",paddingLeft:propUp?"100px":"2px" }}>Keyword 2 :</span>
          <input
            type="text"
            id="fileSearchParam2"
            style={{ flex: "1", height: "20px",marginLeft:propUp?"50px":"20px"  }}
        ...
        >
          ...
          />
          <span style={{ flex: "1", height: "20px",paddingLeft:propUp?"100px":"2px" }}>File Size :</span>
          <span style={{ flex: "1", height: "20px",marginLeft:propUp?"50px":"20px"  }}>
            {(fileSizeFd / 1e6).toFixed(3)}MB
          </span>
        </div>

        <div style={{ display: "flex", alignItems: "center", marginBottom: "5px",whiteSpace: "nowrap"  }}>
          <span style={{ flex: "0.25", height: "20px", margin: "0" }}>Upload Date :</span>
          <span style={{ flex: "0.25",height: "20px", margin: "0"}}>{createdOn}</span>
        </div>
    ...
    <div
      ...
      >
        <Button variant="contained" to="/" color="secondary" onClick={updateFileName}>
          UPDATE
        </Button>
    </div>
    <Snackbar
